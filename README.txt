...
======================
    ...
    This API will dump the commands written in a given text file to the specified sqlite database.
    copy and Place the Text2Sqlite.jar to your classpath and build your     project.
